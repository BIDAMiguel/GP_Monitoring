<?php
    ...
    if(isset($_POST['action'])){
        ...
        if($_POST['action']=="Sheet_Table"){
            ...
            //     $query .='AND (sd.CurringBoothNo LIKE "%'.$_POST["search"]["value"].'%" ';
            //     $query .='OR l.Line LIKE "%'.$_POST["search"]["value"].'%" ';
            //     $query .='OR sd.Shift LIKE "%'.$_POST["search"]["value"].'%" ';
            //     $query .='OR sd.LotNumber LIKE "%'.$_POST["search"]["value"].'%") ';
            // }
            ...
            //     $query .='AND (sc.Shift LIKE "%'.$_POST["search"]["value"].'%" ';
            //     $query .='OR l.Line LIKE "%'.$_POST["search"]["value"].'%" ';
            //     $query .='OR l.Line LIKE "%'.$_POST["search"]["value"].'%" ';
            //     $query .='OR p.PlateType LIKE "%'.$_POST["search"]["value"].'%") ';
            // }
            ...
            if(isset($_POST["order"])){
                ...
                $query .='ORDER BY sd.CurringBoothNo ASC ';
            }
            ...
            $query .= "JOIN line_tbl l ON sd.LineID = l.LineID ";
            $query .= "JOIN platetype_tbl p ON sd.PlateTypeID = p.PlateTypeID ";
            $query .= "WHERE sd.IsActive = 1 and sd.IsDeleted = 0 and sd.DateCreated BETWEEN '".$date." 06:00:00' AND DATEADD(day, +1, '".$date." 06:00:00') ";
